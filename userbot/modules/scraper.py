...
async def text_to_speech(query):
    ...
    xx = await edit_or_reply(query, "`Sabar Ngentod....`")
    if message:
        pass
    elif textx:
        message = textx.text
    ...
    if linecount == 1:
        ...
        tts.save("k.ogg")
    with open("k.ogg", "r"):
        await query.client.send_file(query.chat_id, "k.ogg", reply_to=xx.reply_to_msg_id, voice_note=True)
        os.remove("k.ogg")
        await xx.delete()
