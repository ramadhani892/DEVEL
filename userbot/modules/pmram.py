...
CMD_HELP.update(
    {
        ...
        "•NOTE• : Untuk membuat Kata Kata {cmd}set pmbot, Lo bisa gunain format {mention} untuk menyebut pengguna yang meng start bot lo dan {my_first} untuk memperkenalkan Asisstan lo.\
        "
    }
)
